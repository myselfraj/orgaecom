...
public class HomeFragment extends Fragment {
    ...
    private void getPopularProduct() {
        showProgressDialog();
        Call<ProductResult> call = RestClient.getRestService(getContext()).popularProducts("homepage");
    ...
    private void getNewProduct() {
        showProgressDialog();
        Call<ProductResult> call = RestClient.getRestService(getContext()).newProducts("newProduct");
        call.enqueue(new Callback<ProductResult>() {
            @Override
            public void onResponse(Call<ProductResult> call, Response<ProductResult> response) {
                Log.d("Response :=>", response.body() + "");
    ...
    private void getCategoryData() {
        ...
        Call<CategoryResult> call = RestClient.getRestService(getContext()).allCategory("allCategory");
